                            ...
                            <div class="row">
                                    <div class="span11">
                                     <?php foreach ($weekly_announcements as $row):?>
                                            <div class="span5">   
                                            <h3><a href="<?php echo base_url();?>home/announcements_item/<?php echo $row->announcements_id;?>"><?php echo $row->title;?></a></h3>
                                            <div class="post_meta_top">
                                            <span>Posted on </span>
                                            <span class="post_date"><?php echo $row->date;?></span> 
                                            </div>
                                            <a href="<?php echo base_url();?>home/announcements_item/<?php echo $row->announcements_id;?>"><img src="<?php echo base_url();?>images/<?php echo $row->imagelocation;?>"  class=" alignleft" alt="<?php echo $row->title;?>"/></a> 
                                            <p style="text-align: justify;"><?php echo character_limiter($row->content,135);?><a href="<?php echo base_url();?>firstlady"> Read More</a></p>
                                               <hr/>
                                             </div>
                                             <?php endforeach?>
                                        </div>
